...
class ThanhDieuHeader implements ThanhDieuConfigInterface {
    public $title = "Phương Dev";
    public $description = "Hi my name is Minh Phuong / A freelance / web developer / vexer";
    public $keywords = " ";
    public $favicon = "./res/v5/img/logo.jpg";
    public $namesite = "Phuong Dev";
    public $avatar = "./res/v5/img/avatar.png";
    public $userName = ["Hello Everybody", "My name is Minh Phuong.", "I really like website design 🌭"];
    ...
    public $SocialNetworks = [
        "facebook" => "https://facebook.com/tmphgdzai", // Thay link facebook
        "instagram" => "https://www.instagram.com/tmphgdzai", // Thay link instagram
        "tiktok" => "https://www.tiktok.com/phuongdeveloper", // Thay link tiktok
        "telegram" => "https://t.me/phuongdev" // Thay link telegram
    ];
...
class ThanhDieuLoveDays implements ThanhDieuConfigInterface {
    public $ConfigLove = [
        ...
        "name_male" => "Minh Phuong", // Thay tên của bạn
        //========================================================//
        ...
        "name_female" => "Le Ha", // Thay tên đối phương
        //========================================================//
        "time_relashiption" => "31/12/2023" // Định dạng ngày tháng năm: DD-MM-YYYY or / or :
        //========================================================//
    ];
    public function CommonMethod() {}
}
