...
<head>
    ...
    <meta property="og:url" content="PhuongDev.Com">
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="/res/v5/img/male.jpeg" alt="PhuongDev">
    ...
    <footer id="footer">
        <span>
            <a href="//phuongdev.com" target="_blank">&copy; Copyright&nbsp;PhuongDev 2024</a>
        </span>
    </footer>
    <div class="time-now" id="real-time">00:00:00</div>
    <div id="Toast">BioLink PhuongDev</div>
